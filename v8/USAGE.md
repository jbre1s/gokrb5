...
relevant method:
```go
import "github.com/jbre1s/gokrb5/v8/config"
...
```go
import 	"github.com/jbre1s/gokrb5/v8/keytab"
...
```go
import 	"github.com/jbre1s/gokrb5/v8/client"
...
```go
import 	"github.com/jbre1s/gokrb5/v8/service"
